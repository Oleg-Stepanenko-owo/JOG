...
#define AVC_BIT_0_HOLD_ON_MIN_LENGTH      0x34  // 36 uS * (F_CPU / 1000000L / 8)     0x34 Compare half way between a '1' (20 us) and a '0' (32 us ): 32 - (32 - 20) /2 = 26 us
#define AVC_START_BIT_LENGTH              0x2F  // 188 uS  * (F_CPU / 1000000L / 64) ,  prescaler 64    0x2f
#define AVC_START_BIT_HOLD_ON_LENGTH      0x2A  // 168 uS * (F_CPU / 1000000L / 64)    prescaler 64     0x2a
